...
export 'tema_component_model.dart';

class TemaComponentWidget extends StatefulWidget {
...
class _TemaComponentWidgetState extends State<TemaComponentWidget> {
  late TemaComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TemaComponentModel());
