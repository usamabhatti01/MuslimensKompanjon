...
export 'video_search_model.dart';

class VideoSearchWidget extends StatefulWidget {
  const VideoSearchWidget({super.key});

  static String routeName = 'VideoSearch';
  static String routePath = '/videoSearch';
...
class _VideoSearchWidgetState extends State<VideoSearchWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideoSearchModel());
                                  ...
                                  child: Column(
                                    ...
                                    children: List.generate(videoList.length,
                                      ...
                                      return InkWell(
                                        ...
                                        child: wrapWithModel(
                                          model: _model.videoItemCardModels
                                              .getModel(
                                          ...
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                          child: VideoSearchCardWidget(
                                            key: Key(
                                              'Keybh7_${videoListIndex.toString()}',
                                            ),
