...
import 'bokmrke_heading_model.dart';
export 'bokmrke_heading_model.dart';

class BokmrkeHeadingWidget extends StatefulWidget {
  const BokmrkeHeadingWidget({
    super.key,
  ...
  @override
  State<BokmrkeHeadingWidget> createState() => _BokmrkeHeadingWidgetState();
}

class _BokmrkeHeadingWidgetState extends State<BokmrkeHeadingWidget> {
  late BokmrkeHeadingModel _model;
