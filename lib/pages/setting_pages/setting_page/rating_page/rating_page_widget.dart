...
/// i want to  make rating system of app
                  ...
                  child: Column(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Lottie.network(
                            'https://dimg.dreamflow.cloud/v1/lottie/happy+star+rating+animation',
                            width: 200.0,
                            height: 200.0,
                            fit: BoxFit.contain,
                            animate: true,
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: Wrap(
                                        ...
                                        children: [
                                          wrapWithModel(
                                            model: _model.feedbackChipModel1,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: FeedbackChipWidget(
                                              selected: true,
                                              label: 'Prayer Times',
                                            ),
                                          ),
                                          wrapWithModel(
                                            model: _model.feedbackChipModel2,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: FeedbackChipWidget(
                                              selected: false,
                                          ...
                                          wrapWithModel(
                                            model: _model.feedbackChipModel3,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: FeedbackChipWidget(
                                              selected: false,
                                          ...
                                          wrapWithModel(
                                            model: _model.feedbackChipModel4,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: FeedbackChipWidget(
                                              selected: false,
                                          ...
                                          wrapWithModel(
                                            model: _model.feedbackChipModel5,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: FeedbackChipWidget(
                                              selected: false,
                                          ...
                                          wrapWithModel(
                                            model: _model.feedbackChipModel6,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: FeedbackChipWidget(
                                              selected: false,
