...
import 'video_player_home_model.dart';
export 'video_player_home_model.dart';

class VideoPlayerHomeWidget extends StatefulWidget {
  const VideoPlayerHomeWidget({
    super.key,
  ...
  static String routeName = 'VideoPlayerHome';
  static String routePath = '/videoPlayerHome';

  @override
  State<VideoPlayerHomeWidget> createState() => _VideoPlayerHomeWidgetState();
}

class _VideoPlayerHomeWidgetState extends State<VideoPlayerHomeWidget> {
  late VideoPlayerHomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideoPlayerHomeModel());
