...
import 'morning_adhkar_model.dart';
export 'morning_adhkar_model.dart';

class MorningAdhkarWidget extends StatefulWidget {
  const MorningAdhkarWidget({super.key});

  static String routeName = 'MorningAdhkar';
  static String routePath = '/morningAdhkar';

  @override
  State<MorningAdhkarWidget> createState() => _MorningAdhkarWidgetState();
}

class _MorningAdhkarWidgetState extends State<MorningAdhkarWidget> {
  late MorningAdhkarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MorningAdhkarModel());
